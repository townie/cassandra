...
Gem::Specification.new do |s|
  ...
  s.description = "A Ruby client for the CCassandra distributed database."
  s.email = ""
  ...
  s.rdoc_options = ["--line-numbers", "--inline-source", "--title", "CCassandra", "--main", "README.md"]
  s.require_paths = ["lib", "ext"]
  s.rubyforge_project = "cassandra"
  s.rubygems_version = "1.8.17"
  s.summary = "A Ruby client for the CCassandra distributed database."

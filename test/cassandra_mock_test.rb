...
class CCassandraMockTest < CCassandraTest
  ...
  def setup
    ...
    @twitter = CCassandra::Mock.new('Twitter', @test_schema)
    @twitter.clear_keyspace!

    @blogs = CCassandra::Mock.new('Multiblog', @test_schema)
    @blogs.clear_keyspace!

    @blogs_long = CCassandra::Mock.new('MultiblogLong', @test_schema)
    @blogs_long.clear_keyspace!

    @type_conversions = CCassandra::Mock.new('TypeConversions', @test_schema)
  ...
  def test_get_range_reversed_slice
    ...
    hash = CCassandra::OrderedHash[data]
    sliced_hash = CCassandra::OrderedHash[data.reverse[1..-1]]

...
class OrderedHashTestInt < Test::Unit::TestCase
  def setup
    ...
    @hash = Hash.new
    @ordered_hash = CCassandra::OrderedHash.new
  ...
  def test_merge
    other_hash =  CCassandra::OrderedHash.new
  ...
  def test_alternate_initialization_with_splat
    alternate = CCassandra::OrderedHash[1,2,3,4]
    assert_kind_of CCassandra::OrderedHash, alternate
    assert_equal [1, 3], alternate.keys
  end

  def test_alternate_initialization_with_array
    alternate = CCassandra::OrderedHash[ [
      [1, 2],
      [3, 4],
      "bad key value pair",
      [ 'missing value' ]
  ...
  def test_alternate_initialization_raises_exception_on_odd_length_args
    begin
      alternate = CCassandra::OrderedHash[1,2,3,4,5]
  ...
  def test_replace_updates_keys
    @other_ordered_hash = CCassandra::OrderedHash[:black, '000000', :white, '000000']

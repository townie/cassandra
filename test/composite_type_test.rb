...
class CompositeTypesTest < Test::Unit::TestCase
  ...
  def setup
    ...
    @col = CCassandra::Composite.new(*@col_parts)
    ...
    @dycol = CCassandra::DynamicComposite.new(*@types.zip(@col_parts))
    @dycol_alias = CCassandra::DynamicComposite.new(*@type_aliaes.zip(@col_parts))
  end
  ...
  def test_creation_from_parts
    ...
    col2 = CCassandra::Composite.new_from_parts(@col_parts)
    (0..2).each do |i|
  ...
  def test_packing_and_unpacking
    ...
    col2 = CCassandra::Composite.new_from_packed(@col.pack)
    ...
    col2 = CCassandra::Composite.new(@col.pack)
    assert_equal(@col_parts[0], col2[0])
    assert_equal(@col_parts[1], col2[1])
    assert_equal(@col_parts[2], col2[2])
    assert_equal(@col, col2)
  ...
  def test_packing_and_unpacking_dynamic_columns
    ...
    col2 = CCassandra::DynamicComposite.new_from_packed(@dycol.pack)
    assert_equal(@col_parts[0], col2[0])
    assert_equal(@col_parts[1], col2[1])
    assert_equal(@col_parts[2], col2[2])
    ...
    col2 = CCassandra::DynamicComposite.new(@dycol.pack)
    assert_equal(@col_parts[0], col2[0])
    assert_equal(@col_parts[1], col2[1])
    assert_equal(@col_parts[2], col2[2])
    assert_equal(@dycol, col2)
  ...
  def test_packing_and_unpacking_dynamic_columns_with_aliases
    ...
    col2 = CCassandra::DynamicComposite.new_from_packed(@dycol_alias.pack)
    assert_equal(@col_parts[0], col2[0])
    assert_equal(@col_parts[1], col2[1])
    assert_equal(@col_parts[2], col2[2])
    assert_equal(@dycol_alias, col2)

    col2 = CCassandra::DynamicComposite.new(@dycol_alias.pack)
    assert_equal(@col_parts[0], col2[0])
    assert_equal(@col_parts[1], col2[1])
    assert_equal(@col_parts[2], col2[2])
    assert_equal(@dycol_alias, col2)

...
class ComparableTypesTest < Test::Unit::TestCase
  ...
  def test_long_error
    assert_raises(CCassandra::Comparable::TypeError) do
      Long.new("bogus")
    end
  end
  ...
  def test_long_inspect
    ...
    if RUBY_VERSION < '1.9'
      assert_equal "<CCassandra::Long##{obj.object_id} time: Thu Jan 01 00:00:00 UTC 1970, usecs: 0, jitter: 0, guid: 00000000-0000-0000>", obj.inspect
    else
      assert_equal "<CCassandra::Long##{obj.object_id} time: 1970-01-01 00:00:00 UTC, usecs: 0, jitter: 0, guid: 00000000-0000-0000>", obj.inspect
    end
  end

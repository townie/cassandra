  ...
  module Protocol #:nodoc:
    ...
    def _multi_get_columns(column_family, keys, columns, sub_columns, consistency)
      result = if is_super(column_family) and sub_columns
        predicate = CCassandraThrift::SlicePredicate.new(:column_names => sub_columns)
        column_parent = CCassandraThrift::ColumnParent.new(
        ...
        predicate = CCassandraThrift::SlicePredicate.new(:column_names => columns)
    ...
    def _multiget(column_family, keys, column, sub_column, count, start, finish, reversed, consistency)
      ...
      if is_super(column_family) and sub_column
        predicate = CCassandraThrift::SlicePredicate.new(:column_names => [sub_column])
        ...
        predicate = CCassandraThrift::SlicePredicate.new(:column_names => [column])
        column_parent = CCassandraThrift::ColumnParent.new(:column_family => column_family)
